...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
  e.preventDefault();
  setState("submitting");"use client";
import { useState } from "react";
import AnimSection from "./AnimSection";
import { CONTACT_INFO, SOCIAL_LINKS } from "@/lib/data";

// ─── Replace with your Web3Forms access key ──────────────────────────────────
const WEB3FORMS_ACCESS_KEY = "f7402f0b-4890-4f57-9b7c-1554efa4ea3e";
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <section id="contact" style={{ padding: "96px 32px", background: "var(--bg)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "48px" }}
                ...
                >
                  ...
                  <div>
                    <p style={{
                      ...
                      color: "#00e5a0", letterSpacing: "0.15em",
                ...
                {SOCIAL_LINKS.map((s) => (
                  <a
                    ...
                    style={{
                      ...
                      color: "#8892a4", textDecoration: "none", transition: "all 0.2s",
                    }}
          ...
          <AnimSection delay={200}>
            ...
            {state === "success" && (
              <div style={{
                ...
                fontFamily: "'Fira Code', monospace", fontSize: "13px", color: "#00e5a0",
              }}>
            ...
            {state === "error" && (
              <div style={{
                ...
                borderRadius: "8px", padding: "14px 18px", marginBottom: "18px",
                fontFamily: "'Fira Code', monospace", fontSize: "13px", color: "#ff6b6b",
              }}>
                ❌ Something went wrong. Please email me directly at{" "}
                <a href="mailto:rajeev.sah@nepal.gov.np" style={{ color: "#00e5a0" }}>
                  rajeev.sah@nepal.gov.np
                </a>
              </div>
            )}
