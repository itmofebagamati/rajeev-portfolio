      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "32px", alignItems: "start" }}>
            ...
            {EXPERIENCE.map((exp, i) => (
              ...
              >
                ...
                <motion.div
                  ...
                  whileHover={{ x: 4, borderColor: "rgba(0,229,160,0.35)" }}
                  transition={{ duration: 0.2 }}
                >
                  <span style={{ fontFamily: "'Fira Code', monospace", fontSize: "11px", color: "#00e5a0", letterSpacing: "0.1em" }}>
                    {exp.period}
                  </span>
                  <h3 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: "16px", margin: "6px 0 4px" }}>
                    {exp.role}
                  </h3>
                  <p style={{ color: "#e040fb", fontSize: "13px", fontFamily: "'Fira Code', monospace", marginBottom: "8px" }}>
                    {exp.org}
                  </p>
                  <p style={{ color: "#8892a4", fontSize: "13px", lineHeight: 1.7 }}>{exp.desc}</p>
                </motion.div>
              </motion.div>
            ))}
          </div>
          ...
          <AnimSection delay={150} direction="right">
            <motion.div
              whileHover={{ boxShadow: "0 0 40px rgba(0,229,160,0.1)" }}
              style={{
                minHeight: 280,
                background: "linear-gradient(135deg, #161b27, #1e2535)",
                borderRadius: "12px", border: "1px solid rgba(0,229,160,0.1)",
            ...
            >
              ...
              <p style={{ fontFamily: "'Fira Code', monospace", fontSize: "13px", color: "#8892a4", textAlign: "center", lineHeight: 1.7 }}>
                <span style={{ color: "#00e5a0" }}>5+</span> years of professional experience<br />
                across government and education sectors
              </p>
